    ...
    return (
        <div className="relative h-12 w-12 shrink-0">
            <AvatarImage
                ...
                fallbackText={type === "linkedin" ? "in" : <XLogo className="h-4 w-4" />}
            />
            {badge ? (
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        {channel.id === "all" ? (
                                            ...
                                            <div className="relative">
                                                ...
                                                {openMenu === channel.id ? (
                                                    <div className="absolute right-0 top-[calc(100%+0.4rem)] z-20 min-w-36 rounded-2xl border border-white/10 bg-slate-950/95 p-2 shadow-2xl shadow-black/50">
                                                        <button
                                                            type="button"
                                                            onClick={(event) => {
                                                                event.stopPropagation();
